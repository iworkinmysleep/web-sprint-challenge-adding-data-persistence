...
<!-- Relational database is a type of database that uses tables to organize data.  SQL is a programming language used to manage databases. -->

2. Why do tables need a `primary key`?
<!-- The primary key is used to identify each entry in the database uniquely. -->

3. What is the name given to a table column that references the primary key on another table.
<!-- Foreign key -->

4. What do we need in order to have a _many to many_ relationship between two tables.
<!-- We need an intermediary table that holds foreign keys that reference the primary keys of their related tables. -->
